"""Señales de fraude por suplantación de autoridad (BEC) en español rioplatense — RA1-09.

El analizador de heurísticas del flujo ya cuenta palabras ("transferencia", "urgente"). Este módulo
no repite eso: extrae ENTIDADES verificables (un CBU que pasa el dígito verificador no es una
palabra suelta, es una instrucción de pago concreta) y se presenta como autoridad con grados y
cargos de las Fuerzas Armadas. El patrón BEC lo decide el agente combinándolas con la identidad
verificada y el modelo de relaciones.
"""
