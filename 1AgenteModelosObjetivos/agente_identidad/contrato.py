"""Contratos de datos con el flujo n8n — RG-02, RA1-01.

Entrada: la salida del nodo "Desarmar correo" tal cual (sólo se declaran los campos que el agente
usa; el resto se ignora, así un cambio menor del parser no rompe el contrato).
Salida: el mismo formato que devuelve la función `salida()` de los analizadores del flujo, para
que "Consolidar evidencia y puntuar" la procese sin modificaciones.
"""
