"""Modelo de relaciones remitente→destinatario — RA1-08.

Es el estado interno que convierte al agente en "basado en modelos": recuerda algo que ningún
correo individual muestra (si este remitente ya le escribió antes a este destinatario).

Defensa ante envenenamiento: un atacante que logra que le entreguen UN correo no debe convertirse
en "contacto conocido" para el siguiente. Sólo se aprende de:
- un veredicto humano LEGITIMO, o
- un correo que el flujo entregó (FALSO_POSITIVO) y cuya identidad el Agente 1 VERIFICÓ.
Un veredicto humano MALICIOSO nunca enseña, aunque el flujo lo haya entregado.
"""
