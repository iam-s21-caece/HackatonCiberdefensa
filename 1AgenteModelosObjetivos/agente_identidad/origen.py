"""Percepción de la ruta del correo y de la autenticación declarada — RA1-03, RA1-07.

Cualquiera puede escribir cabeceras `Received` o `Authentication-Results` en su mensaje. Lo único que
el atacante no controla son las cabeceras que agregan NUESTROS servidores al recibirlo, y esas
quedan siempre por ENCIMA de todo lo que trae el mensaje. Por eso el salto confiable es el
`Received` más alto agregado por un MX de la organización, y sólo cuando la vía de entrada garantiza
que esas cabeceras las escribió de verdad nuestra infraestructura.
"""
