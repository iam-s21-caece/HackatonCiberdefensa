...
if (d.canal && d.canal !== 'email') return salida(F, 'sin_artefactos', { conclusion: 'NO_APLICA', canal: d.canal }, [], { nota: 'El Agente 1 verifica identidad de correo (SPF/DKIM/DMARC); no aplica a ' + d.canal });
