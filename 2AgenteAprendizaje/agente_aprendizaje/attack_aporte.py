"""ATT&CK agregado (RA2-07) y aporte medible del Agente 1 (RA2-09).

ATT&CK: el mapeo es del flujo. Acá sólo se cuenta lo que el flujo reportó y se exporta en el
formato de capa de ATT&CK Navigator. No se agrega ni corrige ninguna técnica.

Aporte del Agente 1: con la réplica verificada del motor de puntaje se recalcula cada reporte sin
los hallazgos `a1_*`. Si la réplica no reproduce el puntaje registrado, ese reporte se excluye
(`paridad: false`) en lugar de afirmar un contrafáctico dudoso.
"""
